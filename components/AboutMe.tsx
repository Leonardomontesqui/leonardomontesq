  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#121212] p-4 gap-2 rounded-2xl">
      ...
      <p className="text-sm ">
        ...
        wrote cool research papers at that time related to my love for
        innovative electric machinery. But felt limited in my learning as there
        were no facilities in Lima where a student could get hands on
