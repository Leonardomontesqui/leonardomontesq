...
export default function AboutMe() {
  return (
    <div className="flex flex-col w-full bg-[#121212] p-4 gap-2 rounded-2xl">
      ...
      <p className="text-sm ">
        Hey, I'm Leo! an aspiring software engineer born in Ilo Moquegua, Peru.
        I Graduated from the IB program at 16, wrote cool research papers at
        that time related to my love for innovative electric machinery. But felt
        limited in my learning as there were no facilities in Lima where a
